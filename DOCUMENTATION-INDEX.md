...
| [GETTING-STARTED.md](GETTING-STARTED.md) | Complete getting started guide |
...
| Document | Description |
|----------|-------------|
| [JPMS-REFERENCE.md](JPMS-REFERENCE.md) | ⭐ **Complete JPMS reference guide** (NEW - consolidated) |
| [root/app/jeeeraaah/doc/md/jpms in action - jeeeraaah/jpms in action - jeeeraaah.md](root/app/jeeeraaah/doc/md/jpms in action - jeeeraaah/jpms in action - jeeeraaah.md) | 📚 **JPMS in Action - Publication** |
| [root/app/jeeeraaah/doc/md/modular-software-in-java/modular-software-in-java.md](root/app/jeeeraaah/doc/md/modular-software-in-java/modular-software-in-java.md) | 📚 **Modular Software in Java - Publication** |
...
| Document | Description |
|----------|-------------|
| [IAM-KEYCLOAK-LIBERTY-GUIDE.md](IAM-KEYCLOAK-LIBERTY-GUIDE.md) | ⭐ **Complete IAM guide** |
| [config/CREDENTIALS.md](config/CREDENTIALS.md) | All credentials reference |
...
| Document | Description |
|----------|-------------|
| [API-DOCUMENTATION.md](API-DOCUMENTATION.md) | ⭐ **REST API documentation guide** |
...
| Document | Description |
|----------|-------------|
| [config/shared/docker/LIB-TEST-FIX.md](config/shared/docker/LIB-TEST-FIX.md) | lib_test database automation |
...
| [config/shared/wsl/aliases.sh](config/shared/wsl/aliases.sh) | ⭐ **All project aliases** (includes Liberty!) |
...
| [VSCODE-ERRORS-EXPLAINED-2026-03-01.md](VSCODE-ERRORS-EXPLAINED-2026-03-01.md) | VS Code false-positive errors |

---

## 📚 Archive & History

### Historical Reports (2026-02)
**Location:** `docs/archive/reports-2026-02/`
- ABSCHLUSS-2026-02-20.md - Completion report
- KONSOLIDIERUNG-2026-02-20.md - Package reorganization
- PROJECT-CONSOLIDATION-REPORT.md - Consolidation report
- FINAL-FIXES-SUMMARY.md - Final fixes summary
- HAMCREST-TO-ASSERTJ-MIGRATION-COMPLETE.md - Test migration report
- TODO-16-17-COMPLETION-REPORT.md - TODOs completion
- GANTTAPPRUNNER-FIX-SUMMARY.md - GanttAppRunner fix
- SOLUTION-SUMMARY.md - Keycloak login solution

### Historical Fixes (2026-02)
**Location:** `docs/archive/fixes-2026-02/`
...
4. **[config/CREDENTIALS.md](config/CREDENTIALS.md)** - All credentials
5. **[JPMS-REFERENCE.md](JPMS-REFERENCE.md)** - JPMS guide
6. **[IAM-KEYCLOAK-LIBERTY-GUIDE.md](IAM-KEYCLOAK-LIBERTY-GUIDE.md)** - IAM setup
7. **[API-DOCUMENTATION.md](API-DOCUMENTATION.md)** - REST API guide
8. **[config/QUICK-COMMANDS.md](config/QUICK-COMMANDS.md)** - Common commands
9. **[todo.md](todo.md)** - Current tasks
...
### Useful Scripts
- **`safe-git-push.sh`** - Safe git push helper
- **`setup-fresh-clone.sh`** - Fresh clone setup
- **`count-jpms-encapsulation.py`** - JPMS metrics analysis (in root/)

### Useful Aliases (see [aliases.sh](config/shared/wsl/aliases.sh))
- **`ruu-help`** - Show all available aliases
- **`ruu-docker-startup`** - Start all Docker services
- **`ruu-liberty-start`** - Start Liberty backend (NEW!)
- **`ruu-dash`** - Start JavaFX frontend
- **`ruu-build`** - Build the project

---

**Need help?**  
📘 [config/TROUBLESHOOTING.md](config/TROUBLESHOOTING.md) | 🐛 [VSCODE-ERRORS-EXPLAINED-2026-03-01.md](VSCODE-ERRORS-EXPLAINED-2026-03-01.md)

**For publications:**  
📚 [JPMS in Action](root/app/jeeeraaah/doc/md/jpms in action - jeeeraaah/jpms in action - jeeeraaah.md) | [Modular Software in Java](root/app/jeeeraaah/doc/md/modular-software-in-java/modular-software-in-java.md)
