...
public class TaskFXBean implements TaskEntity<TaskGroupFXBean, TaskFXBean>
{
	...
	public TaskFXBean(@NonNull TaskGroupFXBean taskGroup, TaskEntity<?, ?> task)
	{
		this(taskGroup, task.name());
	...
	@Override public @NonNull TaskFXBean name(@NonNull String name)
	{
