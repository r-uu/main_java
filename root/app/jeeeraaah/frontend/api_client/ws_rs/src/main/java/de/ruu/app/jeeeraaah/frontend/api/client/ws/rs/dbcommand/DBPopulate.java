...
public class DBPopulate
{
	...
	private void populateDatabase() throws NonTechnicalException, TechnicalException
	{
		...
		taskFeatureSet2.start(LocalDate.of(2025, 1,  8));
		taskFeatureSet2.end  (LocalDate.of(2025, 2,  7));
		taskFeatureSet3.start(LocalDate.of(2025, 1, 17));
		taskFeatureSet3.end  (LocalDate.of(2025, 2, 15));
		...
		taskFeature_2_1.start(LocalDate.of(2025, 1,  8));
		taskFeature_2_1.end  (LocalDate.of(2025, 1, 15));
		taskFeature_2_2.start(LocalDate.of(2025, 1, 16));
		taskFeature_2_2.end  (LocalDate.of(2025, 1, 25));
		taskFeature_2_3.start(LocalDate.of(2025, 1, 26));
		taskFeature_2_3.end  (LocalDate.of(2025, 1, 31));
		taskFeature_2_4.start(LocalDate.of(2025, 2,  1));
		taskFeature_2_4.end  (LocalDate.of(2025, 2,  7));
		taskFeature_3_1.start(LocalDate.of(2025, 1, 17));
		taskFeature_3_1.end  (LocalDate.of(2025, 1, 25));
		taskFeature_3_2.start(LocalDate.of(2025, 1, 26));
		taskFeature_3_2.end  (LocalDate.of(2025, 1, 31));
		taskFeature_3_3.start(LocalDate.of(2025, 2,  1));
		taskFeature_3_3.end  (LocalDate.of(2025, 2,  7));
		taskFeature_3_4.start(LocalDate.of(2025, 2,  8));
		taskFeature_3_4.end  (LocalDate.of(2025, 2, 15));
