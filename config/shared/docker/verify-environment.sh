...
echo ""
echo "Next Steps:"
echo "  1. Build project: cd ~/develop/github/java/main/root && mvn clean install"
echo "  2. Start backend: cd ~/develop/github/java/main/root/app/jeeeraaah/backend/api/ws_rs && mvn liberty:dev"
